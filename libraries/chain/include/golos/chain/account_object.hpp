    ...
    account_object,
        indexed_by<
                ...
                ordered_non_unique<tag<by_savings_seconds>,
                    member<account_object, uint128_t, &account_object::savings_sbd_seconds>,
...
FC_REFLECT((golos::chain::account_object),
    ...
    (comment_count)(lifetime_vote_count)(post_count)(sponsor_count)(referral_count)(can_vote)(voting_power)(last_vote_time)(reputation)
    (balance)
    (savings_balance)
