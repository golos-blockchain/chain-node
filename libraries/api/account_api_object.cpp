...
account_api_object::account_api_object(const account_object& a, const golos::chain::database& db)
    :   id(a.id), name(a.name), memo_key(a.memo_key), proxy(a.proxy),
        ...
        lifetime_vote_count(a.lifetime_vote_count), post_count(a.post_count), sponsor_count(a.sponsor_count), referral_count(a.referral_count),
        ...
        balance(a.balance), savings_balance(a.savings_balance), accumulative_balance(a.accumulative_balance), tip_balance(a.tip_balance), market_balance(a.market_balance), nft_hold_balance(a.nft_hold_balance),
