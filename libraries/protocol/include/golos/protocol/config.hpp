...
#define STEEMIT_BLOCKCHAIN_VERSION              (version(0, 25, 0))
...
#define STEEMIT_CASHOUT_WINDOW_SECONDS          (5*60) /// 5 minutes
...
#define STEEMIT_VESTING_WITHDRAW_INTERVALS      8
...
//1.425% inflation
#define GOLOS_WORKER_REWARD_PERCENT             (15.00*STEEMIT_1_PERCENT)
