...
#define GOLOS_WORKER_REQUEST_APPROVE_TERM_SEC  (60*60*24) // Limit to prevent the overflow
...
#define GOLOS_WORKER_FROM_VESTING_FUND_PERCENT  (10.00*STEEMIT_1_PERCENT)
#define GOLOS_WORKER_FROM_WITNESS_FUND_PERCENT  (10.00*STEEMIT_1_PERCENT)
#define GOLOS_WORKER_REQUEST_APPROVE_TERM_SEC  (60*60*24*30*12) // Limit to prevent the overflow
