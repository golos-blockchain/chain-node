...
//
    ...
    auto operation_writer::operator()(const claim_operation& op) -> result_type {
        result_type body;
        return body;
    }

    auto operation_writer::operator()(const donate_operation& op) -> result_type {
        result_type body;
        return body;
    }
    ...
    auto operation_writer::operator()(const asset_create_operation& op) -> result_type {
        result_type body;
        return body;
    }
    ...
    auto operation_writer::operator()(const asset_issue_operation& op) -> result_type {
        result_type body;
        return body;
    }
    ...
    auto operation_writer::operator()(const override_transfer_operation& op) -> result_type {
        result_type body;
        return body;
    }
